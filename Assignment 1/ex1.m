...
% files listed above and the 'lib' folder. If it does not, right-click the 'ex1' 
...
plot(1:num_iters, J1(1:200), '-b', 'LineWidth', 2);
xlabel('Number of iterations');
ylabel('Cost J');
hold on
plot(1:num_iters, J2(1:200), '-r', 'LineWidth', 2);
xlabel('Number of iterations');
ylabel('Cost J');
hold off
%% 
